      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-5">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {/* Record Submit Date — auto, locked */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Record Submit Date
              ...
              <div className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm bg-gray-50 text-gray-500 flex items-center gap-2 cursor-not-allowed select-none">
                ...
                <span className="ml-auto text-xs text-gray-400 bg-gray-100 px-2 py-0.5 rounded-full">Aaj</span>
              </div>
              <p className="text-xs text-gray-400 mt-1">Yeh date automatically save hogi — change nahi hogi</p>
            </div>
